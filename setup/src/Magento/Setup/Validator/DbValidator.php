...
class DbValidator
{
     ...
     * @throws \Magento\Setup\Exception
     */
    private function checkDatabaseName(\Magento\Framework\DB\Adapter\AdapterInterfaceIbm $connection, $dbName)
    {
        try {
     ...
     * @throws \Magento\Setup\Exception
     */
    private function checkDatabasePrivileges(\Magento\Framework\DB\Adapter\AdapterInterfaceIbm $connection, $dbName)
    {
        $requiredPrivileges = [
            'SELECT',
            'INSERT',
