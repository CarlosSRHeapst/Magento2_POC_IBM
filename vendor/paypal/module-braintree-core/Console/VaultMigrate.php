...
class VaultMigrate extends Command
{
     ...
     * @return string
     */
    private function getEavAttributeId(AdapterInterfaceIbm $db): string
    {
        $select = $db->select()
    ...
    /**
     * @param AdapterInterfaceIbm $db
     * @param OutputInterface $output
     * @param $eavAttributeId
     * @return mixed
     */
    private function getStoredCards(AdapterInterfaceIbm $db, OutputInterface $output, $eavAttributeId)
    {
        $select = $db->select()
