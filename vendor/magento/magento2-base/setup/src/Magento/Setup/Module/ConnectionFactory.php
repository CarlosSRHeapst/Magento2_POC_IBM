...
//DB2MOD Usa clase intefaz de IBM
//use Magento\Framework\Model\ResourceModel\Type\Db\Pdo\Mysql;
use Magento\Framework\Model\ResourceModel\Type\Db\Pdo\Ibm;
...
class ConnectionFactory implements \Magento\Framework\Model\ResourceModel\Type\Db\ConnectionFactoryInterface
{
    ...
    public function create(array $connectionConfig)
    {
        ...
        $IbmFactory = new \Magento\Framework\DB\Adapter\Pdo\IBMFactory($objectManagerProvider->get());
        $resourceInstance = new Ibm($connectionConfig, $IbmFactory);
