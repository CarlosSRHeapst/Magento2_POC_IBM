...
class Database extends \Magento\MediaStorage\Model\ResourceModel\File\Storage\AbstractStorage
{
    ...
    public function createDatabaseScheme()
    {
        ...
        $ddlTable = $connection->newTable(
            ...
            $connection->getIndexName(
                ...
                \Magento\Framework\DB\Adapter\AdapterInterfaceIbm::INDEX_TYPE_UNIQUE
            ),
            ['filename', 'directory_id'],
            ['type' => \Magento\Framework\DB\Adapter\AdapterInterfaceIbm::INDEX_TYPE_UNIQUE]
        )->addIndex(
     ...
     */
    private function createResourceConnection(?string $connectionName): AdapterInterfaceIbm
    {
