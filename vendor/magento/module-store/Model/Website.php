    ...
    \Magento\Store\Api\Data\WebsiteInterface
{
    ...
    {
        //DB2MOD WEBSITE
        //echo "DB2MOD WEBSITE 2 " . PHP_EOL;
        //default_group_id
        //DB2MOD FIX
        //--Prueba adicional CODE NAME
        //var_dump($this->_getData('NAME'));
        //echo "HOLA";
    ...
    public function setDefaultGroupId($defaultGroupId)
    {
        //DB2MOD WEBSITE
        //echo "DB2MOD WEBSITE 2 " . PHP_EOL;
        //default_group_id cambiado por DEFAULT_GROUP_ID error de lenguaje
        //DB2MOD FIX
    ...
    {
        //--Basado en prueba adicional
        //var_dump($this->_getData('CODE'));
        //echo "HOLA";
