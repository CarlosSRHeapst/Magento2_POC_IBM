...
class GroupTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $transactionManagerMock->expects($this->any())
            ->method('start')
            ->willReturn($this->getMockForAbstractClass(AdapterInterfaceIbm::class));
    ...
    public function testSaveWithReservedId()
    {
        ...
        $dbAdapter = $this->getMockBuilder(AdapterInterfaceIbm::class)
    ...
    {
        $dbAdapter = $this->getMockForAbstractClass(AdapterInterfaceIbm::class);
        $this->resource->expects($this->any())->method('getConnection')->willReturn($dbAdapter);
