...
abstract class AbstractAction
{
        ...
        foreach ($selects as $select) {
            $this->connection->query(
                $this->connection->insertFromSelect(
                    ...
                    \Magento\Framework\DB\Adapter\AdapterInterfaceIbm::INSERT_ON_DUPLICATE
                )
            );
        }
    }
    ...
    protected function makeTempCategoryTreeIndex()
    {
        ...
        $temporaryTable->addIndex(
            'idx_primary',
            ['parent_id', 'child_id'],
            ['type' => \Magento\Framework\DB\Adapter\AdapterInterfaceIbm::INDEX_TYPE_PRIMARY]
        );

        $temporaryTable->addIndex(
            'child_id',
            ['child_id'],
            ['type' => \Magento\Framework\DB\Adapter\AdapterInterfaceIbm::INDEX_TYPE_INDEX]
        );
