...
class Zend_Db_Adapter_Pdo_Ibm extends Zend_Db_Adapter_Pdo_Abstract
{
    ...
    protected function _dsn()
    {
        ...
        /*DB2MOD 30DIC PROBLEMAS CON QUERIES, ESTA MAL DEBE SER  -SE CAMBIA-
        $db = new PDO("ibm:DRIVER={IBM DB2 ODBC DRIVER};DATABASE=testdb;" .
        "HOSTNAME=11.22.33.444;PORT=56789;PROTOCOL=TCPIP;", "testuser", "tespass");*/

        //Pero lo encuentra en abstract en la lista sin dar un error
        //Original
        //return $this->_pdoType . ': ' . $dsn;
        //Modificado
        return $this->_pdoType . ':DRIVER={IBM DB2 ODBC DRIVER}' . $dsn;
    }
