...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    {
        //DB2MOD Investigacion de datos correctos de DB2
        //DB2MOD Investigacion 18 enero 19 enero
        // connect to the database if needed

        //27/03/2023 Nueva investigación
        //Aqui ya trae todo mal
        //var_dump($sql);

        $this->_connect();
        //echo "Aqui ya viene como string (abstract query) " . $sql;
    ...
    public function fetchAll($sql, $bind = array(), $fetchMode = null)
    {
        ...
        //Zend_Db::FETCH_ASSOC
        //DB2MOD 29/03/2023 request_path
        //objetos select
        //var_dump(get_class($sql));
        $stmt = $this->query($sql, $bind);
        $result = $stmt->fetchAll($fetchMode);
        //DB2MOD IMPORTANTE AQUI ESTAN LOS RESULTADOS DEL SELECT, este es un array 19 Enero
        /*foreach ($result as $clave => $valor) {
            echo "{$clave}" . PHP_EOL;
            print_r($valor);
            echo "FIN_DE_ARREGLO_{$clave}" . PHP_EOL;
        }
