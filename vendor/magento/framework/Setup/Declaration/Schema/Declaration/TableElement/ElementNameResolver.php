...
class ElementNameResolver
{
    ...
    public function getFullIndexName(
        Table $table,
        array $columns,
        ?string $type = AdapterInterfaceIbm::INDEX_TYPE_INDEX
    ): string {
        if (AdapterInterfaceIbm::INDEX_TYPE_PRIMARY === $type) {
            return strtoupper(AdapterInterfaceIbm::INDEX_TYPE_PRIMARY);
        }
        ...
        $isIndexTypeOutOfList = false === array_search(
            $type,
            [AdapterInterfaceIbm::INDEX_TYPE_FULLTEXT, AdapterInterfaceIbm::INDEX_TYPE_UNIQUE]
        );
