...
interface BatchProviderInterface
{
     ...
     *
     * @param AdapterInterfaceIbm $adapter database adapter.
     ...
     * @since 101.0.0
     */
    public function getBatches(AdapterInterfaceIbm $adapter, $tableName, $linkField, $batchSize);
     ...
     * @since 101.0.0
     */
    public function getBatchIds(AdapterInterfaceIbm $connection, Select $select, array $batch);
}
