...
class AbstractDbTest extends TestCase
{
    ...
    {
        $connectionMock = $this->getMockForAbstractClass(AdapterInterfaceIbm::class);
    ...
    {
        $connectionInterfaceMock = $this->getMockForAbstractClass(AdapterInterfaceIbm::class);
    ...
    {
        $connectionMock = $this->getMockBuilder(AdapterInterfaceIbm::class)
            ->addMethods(['save'])
    ...
    public function testSaveNewObject($pkIncrement): void
    {
        ...
        // Mocked behavior
        $connectionMock = $this->getMockBuilder(AdapterInterfaceIbm::class)->disableOriginalConstructor()
