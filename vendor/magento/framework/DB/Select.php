...
class Select extends \Zend_Db_Select
{
     ...
     *
     * @param Adapter\Pdo\Ibm $adapter
     * @param Select\SelectRenderer $selectRenderer
     * @param array $parts
     */
    public function __construct(
        \Magento\Framework\DB\Adapter\Pdo\Ibm $adapter,
    ...
    {
        $mode = $onDuplicate ? AdapterInterfaceIbm::INSERT_ON_DUPLICATE : false;
    ...
    {
        return $this->getConnection()->insertFromSelect($this, $tableName, $fields, AdapterInterfaceIbm::INSERT_IGNORE);
    }
