...
class Tree
{
    ...
    public function __construct($config = [])
    {
        ...
        if (!empty($config['db'])) {
            ...
            // make sure it's a \Magento\Framework\DB\Adapter\AdapterInterfaceIbm
            if (!$connection instanceof \Magento\Framework\DB\Adapter\AdapterInterfaceIbm) {
                throw new LocalizedException(
                    new Phrase('db object does not implement \Magento\Framework\DB\Adapter\AdapterInterfaceIbm')
                );
            }
