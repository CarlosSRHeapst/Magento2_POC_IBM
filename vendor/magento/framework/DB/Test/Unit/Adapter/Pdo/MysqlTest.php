...
class MysqlTest extends TestCase
{
    ...
    public function testCheckNotDdlTransaction($query)
    {
        ...
        try {
            ...
            $this->assertStringNotContainsString(
                $e->getMessage(),
                AdapterInterfaceIbm::ERROR_DDL_MESSAGE
            );
        }
    ...
    {
        $adapter = $this->getMysqlPdoAdapterMock([]);
        $this->expectExceptionMessage(AdapterInterfaceIbm::ERROR_ASYMMETRIC_ROLLBACK_MESSAGE);
        $adapter->rollBack();
    }
    ...
    {
        $adapter = $this->getMysqlPdoAdapterMock([]);
        $this->expectExceptionMessage(AdapterInterfaceIbm::ERROR_ASYMMETRIC_COMMIT_MESSAGE);
        $adapter->commit();
    }
    ...
    public function testIncompleteRollBackFailureOnCommit()
    {
        ...
        try {
            ...
            $this->assertEquals(
                AdapterInterfaceIbm::ERROR_ROLLBACK_INCOMPLETE_MESSAGE,
                $e->getMessage()
            );
            $adapter->rollBack();
        }
    ...
    public function getIndexNameDataProvider()
    {
        ...
        return [
            [$longTableName, [], AdapterInterfaceIbm::INDEX_TYPE_UNIQUE, 'UNQ_'],
            [$longTableName, [], AdapterInterfaceIbm::INDEX_TYPE_FULLTEXT, 'FTI_'],
            [$longTableName, [], AdapterInterfaceIbm::INDEX_TYPE_INDEX, 'IDX_'],
        ...
        return [
            'New unique index' => [
                ...
                'keyLists' => [
                    'PRIMARY' => [
                        'INDEX_TYPE' => [
                            AdapterInterfaceIbm::INDEX_TYPE_PRIMARY
                        ]
                    ],
                ],
            ...
            'Existing unique index' => [
                ...
                'keyLists' => [
                    ...
                    'SOME_UNIQUE_INDEX' => [
                        'INDEX_TYPE' => [
                            AdapterInterfaceIbm::INDEX_TYPE_UNIQUE
                        ]
                    ],
                ],
