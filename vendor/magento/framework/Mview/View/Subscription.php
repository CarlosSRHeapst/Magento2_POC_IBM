...
class Subscription implements SubscriptionInterface
{
    ...
    {
        echo "DB2MOD quoteIdentifier Estoy pasando aqui 2 " . PHP_EOL;
    ...
    {
        echo "DB2MOD quoteIdentifier Estoy pasando aqui 3 " . PHP_EOL;
    ...
    {
        //DB2MOD $this->connection->quoteIdentifier
        echo "DB2MOD quoteIdentifier Estoy pasando aqui 4 " . PHP_EOL;
