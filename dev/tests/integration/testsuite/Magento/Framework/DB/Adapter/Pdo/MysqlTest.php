 ...
 * DB2MOD Cambiado para evitar el error
 */
...
class MysqlTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        if (!$this->getDbAdapter() instanceof \Magento\Framework\DB\Adapter\Pdo\Ibm) {
            $this->markTestSkipped('This test is for \Magento\Framework\DB\Adapter\Pdo\Ibm');
        }
        try {
            $minWaitTimeout = 1;
            ...
            $this->assertInstanceOf(\Magento\Framework\DB\Statement\Pdo\Ibm::class, $result);
        } finally {
     ...
     *
     * @return \Magento\Framework\DB\Adapter\Pdo\Ibm
     */
