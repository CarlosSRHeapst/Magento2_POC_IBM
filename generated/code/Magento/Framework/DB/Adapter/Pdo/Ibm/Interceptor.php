<?php
namespace Magento\Framework\DB\Adapter\Pdo\Ibm;

/**
 * Interceptor class for @see \Magento\Framework\DB\Adapter\Pdo\Ibm
 */
class Interceptor extends \Magento\Framework\DB\Adapter\Pdo\Ibm implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_connect');
        return $pluginInfo ? $this->___callPlugins('_connect', func_get_args(), $pluginInfo) : parent::_connect();
    }
