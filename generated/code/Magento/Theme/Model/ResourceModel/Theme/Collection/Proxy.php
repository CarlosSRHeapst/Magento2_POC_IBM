...
/**
 * Proxy class for @see \Magento\Theme\Model\ResourceModel\Theme\Collection
 */
class Proxy extends \Magento\Theme\Model\ResourceModel\Theme\Collection implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Theme\\Model\\ResourceModel\\Theme\\Collection', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->addParentTitle();
    }
    ...
    {
        return $this->_getSubject()->addAreaFilter($area);
    }
    ...
    {
        return $this->_getSubject()->addTypeRelationFilter($typeParent, $typeChild);
    }
    ...
    {
        return $this->_getSubject()->addTypeFilter($type);
    }
    ...
    {
        return $this->_getSubject()->filterVisibleThemes();
    }
    ...
    {
        return $this->_getSubject()->getThemeByFullPath($fullPath);
    }
    ...
    {
        return $this->_getSubject()->updateChildRelations($themeModel);
    }
    ...
    {
        return $this->_getSubject()->filterPhysicalThemes($page, $pageSize);
    }
    ...
    {
        return $this->_getSubject()->filterThemeCustomizations($area, $type);
    }
    ...
    {
        return $this->_getSubject()->getLabels();
    }
    ...
    {
        return $this->_getSubject()->loadRegisteredThemes();
    }
